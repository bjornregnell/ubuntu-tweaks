...
function setup_environment {
  ...
  URL="http://support.lu.se"
  SUPPORT="servicedesk@lu.se"
if [ ! -z "$DISPLAY" ] ; then
...
if ! ask "This installer will only work properly if you are a member of ${bf}Lund University.${n}" "Continue" 1 ; then exit; fi
...
-----BEGIN CERTIFICATE-----

...

-----END CERTIFICATE-----
...
class EduroamNMConfigTool:
    ...
    def add_connection(self,ssid):
        server_alt_subject_name_list = dbus.Array({'DNS:radius.lu.se'})
        server_name = 'radius.lu.se'
        if self.nm_version == "0.9" or self.nm_version == "1.0":
...
network={
  ...
  identity="${USER_NAME}"
  domain_suffix_match="radius.lu.se"
  phase2="auth=MSCHAPV2"
  password="${PASSWORD}"
}
EOFW
